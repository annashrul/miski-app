...
import 'package:miski_shop/config/app_config.dart';
...
import 'package:miski_shop/pages/component/auth/signup_component.dart';
import 'package:miski_shop/pages/component/brand/brand_component.dart';
import 'package:miski_shop/pages/component/category/category_component.dart';
import 'package:miski_shop/pages/component/chat/room_chat_component.dart';
import 'package:miski_shop/pages/component/checkout/channel_component.dart';
import 'package:miski_shop/pages/component/checkout/checkout_component.dart';
import 'package:miski_shop/pages/component/checkout/success_checkout_component.dart';
import 'package:miski_shop/pages/component/checkout/success_checkout_virtual_account_component.dart';
import 'package:miski_shop/pages/component/history/detail_history_order_component.dart';
import 'package:miski_shop/pages/component/history/history_order_component.dart';
import 'package:miski_shop/pages/component/home/home_component.dart';
import 'package:miski_shop/pages/component/main_component.dart';
import 'package:miski_shop/pages/component/on_boarding_component.dart';
import 'package:miski_shop/pages/component/splash_screen_component.dart';
import 'package:miski_shop/pages/component/tenant/tenant_component.dart';
import 'package:miski_shop/pages/widget/product/by_brand/product_by_brand.dart';
import 'package:miski_shop/pages/widget/product/by_category/product_by_category_widget.dart';
import 'package:miski_shop/pages/widget/product/cart/cart_widget.dart';
import 'package:miski_shop/pages/widget/product/detail/detail_product_widget.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/${StringConfig.successCheckoutVirtualAccount}':
        return CupertinoPageRoute(builder: (_) => SuccessCheckoutVirtualAccountComponent(detailCheckoutVirtualAccountModel: args));
