...
//
//     final detailCartModel = detailCartModelFromJson(jsonString);

import 'dart:convert';

DetailCartModel detailCartModelFromJson(String str) => DetailCartModel.fromJson(json.decode(str));

String detailCartModelToJson(DetailCartModel data) => json.encode(data.toJson());
...
class DetailCartModel {
  ...
  factory DetailCartModel.fromJson(Map<String, dynamic> json) => DetailCartModel(
